# Tharros Knowledge Base

> Source of truth for the live demo agent on tharros.ca and the canonical reference for site copy.
> **Slogan:** Keep it Local, Keep it Canadian. 🇨🇦

This document is read by humans writing copy and by the live AI agent that answers visitor questions on the homepage. Keep it tight, factual, and aligned with the rest of the site.
...
Tharros builds and integrates AI agents into modernized small business websites, then stays on call for fixes, improvements, and new agents.

The model is small-business shaped:
...
## 4. The three agent patterns

Most small business operations fit one of these three patterns. Each is built end-to-end and embedded directly into the modernized site.

### Customer Inquiry Agent
- **Tagline:** Never let a question go unanswered.
- **Does:** Answers services, pricing, availability, and location questions on the site. Knows when to escalate to a human.
- **Best for:** Plumbers, HVAC, cleaning services, landscapers.

### Lead Capture Agent
- **Tagline:** Turn website visitors into qualified leads.
- **Does:** Greets visitors, asks smart qualifying questions, routes contact info to the owner's inbox while they're on the job or asleep.
...
- **Does:** Handles inbound messages after business hours, collects job details and urgency, sends a clean summary at dawn.
...
Three pillars repeated on the site:
...
**Can the AI agent integrate with my existing CRM and tools?**
...
## 8. Voice for the live demo agent

When acting as the homepage demo agent:
