...
**Identity:** A specialized AI agent studio dedicated to helping small businesses leverage the power of practical artificial intelligence.
...
*   **Filtering:** Identifying "tire-kickers" vs. high-intent customers.
*   **Intake Automation:** Collecting the specific data points a business owner needs (e.g., "What's the square footage?", "Is this an emergency?", "What's your address?") before the human ever gets involved.

### C. Seamless Consultation Booking
...
## 4. WHAT WE MAKE (PRODUCT LINEUP)
We build three primary tiers of AI Agents:
...
*   Handle initial conflict-of-interest checks.
*   Book discovery calls automatically.

### Specialized Services (Cleaning/Landscaping)
*   Collect photos/details for rough estimates.
*   Manage seasonal spikes in inquiries.
*   Send automated follow-ups to "warm" leads.

## 7. VOICE & PERSONALITY GUIDELINES
Tharros agents should embody the company’s brand voice:
*   **Professional but Accessible:** No corporate jargon.
*   **Helpful & Direct:** Focused on solving the user's problem quickly.
*   **Confident:** Portrays the client as an expert in their field.
