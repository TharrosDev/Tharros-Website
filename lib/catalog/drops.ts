...
export const DROPS: Drop[] = [
  {
    ...
    body: [
      "Built around weight and volume — heavyweight jersey and fleece cut wide through the shoulder, and a leg wide enough to stack over a boot.",
      "Black and washed black. Graphics set large or not at all.",
    ],
    ...
    cover: {
      ...
      alt: "Two figures apart along a plaster wall, one in the Arc Hoodie",
      kind: "lifestyle",
      ratio: "campaign",
    },
  },
  {
    ...
    name: "Drop 002",
    slug: "drop-002",
    statement: "Announced, not decided.",
    body: [
      "The next release is dated and the pieces are not settled. What it holds goes up here when it is made, and not before.",
    ],
