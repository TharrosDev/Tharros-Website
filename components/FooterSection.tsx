      ...
      <div className="max-w-4xl xl:max-w-6xl mx-auto text-center relative z-10">
        <AnimatedSection variant="scale-in">
          <div className="flex flex-col items-center mb-16 md:mb-20">
            ...
            <h2 className="text-4xl md:text-7xl xl:text-8xl font-bold text-white mb-8 md:mb-10 leading-[1] md:leading-[0.9] tracking-tighter">
              Ready to stop <br className="hidden md:block" />
              <span className="text-accent-3">missing leads?</span>
            </h2>
            <p className="text-slate-300 text-base md:text-2xl xl:text-3xl mb-12 max-w-2xl xl:max-w-4xl mx-auto leading-relaxed font-medium opacity-80 px-4 sm:px-0">
              Set up a free initial briefing. We&apos;ll listen to your business operations and identify your best use case, no obligation.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 md:gap-12 mb-20 md:mb-28 w-full px-6 sm:px-0">
          ...
          <div className="text-slate-500 text-[10px] font-black flex flex-col items-center justify-center gap-6 uppercase tracking-[0.2em]">
