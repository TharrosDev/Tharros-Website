...
export default function IntakeForm() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans selection:bg-accent-3/30 selection:text-slate-900">
      <main className="flex-1 pt-24 md:pt-32 pb-12 md:pb-20 px-5 sm:px-6 md:px-8 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            {!state.succeeded ? (
              ...
              >
                ...
                <div className="lg:col-span-5 pt-2 lg:pt-4">
                  <p className="section-label mb-4 sm:mb-6 tracking-[0.3em] text-[9px] md:text-[10px] uppercase font-bold text-slate-500">Keep it Local, Keep it Canadian</p>
                  <h1 className="text-[2.4rem] leading-[1.05] sm:text-4xl md:text-6xl font-bold text-slate-900 tracking-tighter mb-5 sm:mb-8 sm:leading-[1.1]">
                    Discovery <br />
                    <span className="text-accent-3">Briefing.</span>
                  </h1>
                  <p className="text-slate-600 text-base md:text-lg leading-relaxed mb-7 sm:mb-10">
                    ...
                    {[
                      ...
                      <div key={item.title} className="flex gap-4 items-start">
                        ...
                        <div>
                          ...
                          <p className="text-sm md:text-sm text-slate-500 leading-relaxed">{item.desc}</p>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="lg:col-span-7">
                  <div className="bg-white rounded-3xl md:rounded-[2.5rem] border border-slate-200 shadow-2xl p-5 sm:p-7 md:p-12 relative overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8 relative z-10">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <div className="space-y-2">
                          ...
                          <input required name="name" type="text" placeholder="John Smith" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 sm:px-5 py-3.5 md:py-4 text-base md:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-accent-3/50 focus:bg-white transition-all shadow-sm min-h-[48px]" />
                        ...
                        <div className="space-y-2">
                          ...
                          <input required name="email" type="email" placeholder="John.smith@gmail.com" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 sm:px-5 py-3.5 md:py-4 text-base md:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-accent-3/50 focus:bg-white transition-all shadow-sm min-h-[48px]" />
                      ...
                      <div className="space-y-2">
                        ...
                        <input required name="company" type="text" placeholder="Organization Name" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 sm:px-5 py-3.5 md:py-4 text-base md:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-accent-3/50 focus:bg-white transition-all shadow-sm min-h-[48px]" />
                      ...
                      <div className="space-y-2">
                        ...
                        <input name="website" type="url" placeholder="https://yourwebsite.com" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 sm:px-5 py-3.5 md:py-4 text-base md:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-accent-3/50 focus:bg-white transition-all shadow-sm min-h-[48px]" />
                      ...
                      <div className="space-y-2">
                        ...
                        <textarea required name="needs" rows={5} placeholder="Tell us about your business and where AI could help. What tasks or inquiries are eating your week? Are you looking for a site refresh, an agent integration, or the full On-Call package?" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 sm:px-5 py-3.5 md:py-4 text-base md:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-accent-3/50 focus:bg-white transition-all shadow-sm resize-y min-h-[140px]" />
                      ...
                      <div className="pt-4">
                        <button 
                          ...
                          type="submit" 
                          className="w-full bg-slate-900 text-white font-bold py-4 md:py-5 rounded-xl uppercase tracking-[0.25em] sm:tracking-[0.3em] text-[11px] md:text-xs hover:bg-slate-950 transition-all shadow-2xl active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-3 min-h-[52px]"
                        >
                          {state.submitting ? (
