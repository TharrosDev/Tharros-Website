  ...
  return (
    <>
      ...
      {/* The gutters are the grid's manners: a piece needs more room from the
          ...
          `items-stretch` is the default and it is load-bearing here: the card
          is a full-height column, so every specimen line in a row sits on one
          baseline however many lines a name takes. */}
