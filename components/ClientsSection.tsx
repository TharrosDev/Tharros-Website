...
const clients: Client[] = [
  {
    ...
    lede: "A 24/7 knowledge agent built into the Meridian Society forum.",
    description:
      "Reads the live discussions and resource library so members get answers without waiting on a moderator. Tharros stays on call to tune answers and ship new agents as the community grows.",
  ...
  },
  {
    ...
    lede: "A marketing site that packages enterprise Microsoft 365 work as a product.",
    description:
      "SharePoint, Teams, and OneDrive rollout governance presented as a single offering, with a clean route from positioning to a discovery call.",
  ...
  },
  {
    ...
    lede: "A positioning site for public-sector change management.",
    description:
      "Built around the voice \"Change that lands. Tools that get used.\" A tight funnel that takes government teams from problem statement to booked call.",
