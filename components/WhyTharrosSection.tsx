  ...
  return (
    <section id="why" className="rhythm-breath bg-[color:var(--surface-dark)] text-[color:var(--ink-on-dark)]">
      <div className="page-frame">
        ...
        {/* Founder manifesto — the emotional peak, near full-bleed */}
        <AnimatedSection delay={0.1}>
          <figure className="max-w-[20ch] md:max-w-none">
            <span className="type-meta text-[color:var(--ink-on-dark-muted)] block mb-8">From the founder</span>
            <blockquote>
              <p className="text-[color:var(--ink-on-dark)] max-w-[24ch] md:max-w-[20ch] [font-size:var(--type-display-2)] [line-height:1.02] [letter-spacing:-0.028em] font-semibold">
